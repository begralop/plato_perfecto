...
class RecipeRemoteModel {
  ...
  factory RecipeRemoteModel.fromJson(Map<String, dynamic> json) {
    return RecipeRemoteModel(
        idMeal: json["idMeal"],
  ...
  Map<String, dynamic> toMap() => {
    ...
    // Función para decodificar una lista de recetas.
List<RecipeRemoteModel> recipeListFromJson(Map<String, dynamic> json) {
  List<dynamic> meals = json["meals"];
  return meals.map((meal) => RecipeRemoteModel.fromJson(meal)).toList();
}
}
