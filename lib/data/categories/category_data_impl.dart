...
class CategoryDataImpl extends CategoryRepository {
  ...
  CategoryDataImpl({required CategoryRemoteImpl remoteImpl}) : _remoteImpl = remoteImpl;

  @override
  Future<List<Category>> getCategories() async {
    final remoteCateoriesList = await _remoteImpl.getCategories();
    return remoteCateoriesList.map((e) => CategoryRemoteMapper.fromRemote(e)).toList();
  }
